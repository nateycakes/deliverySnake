...
func place_new_pickup() -> void:
	...
	var min_x_bound = level_marker_tl.global_position.x / tile_size
	var max_x_bound = level_marker_tr.global_position.x / tile_size
	var min_y_bound = level_marker_tl.global_position.y / tile_size
	var max_y_bound = level_marker_bl.global_position.y / tile_size
	...
	var new_position : Vector2 = Vector2(new_pickup_x * tile_size, new_pickup_y * tile_size)
	...
	while excluded_positions.find(new_position) != -1:
		...
		new_position = Vector2(new_pickup_x * tile_size, new_pickup_y * tile_size)
